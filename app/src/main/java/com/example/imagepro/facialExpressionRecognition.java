...
// Initialize vibrator
    ...
    public Mat recognizeImage(Mat mat_image){
        ...
        for (int i=0;i<faceArray.length;i++){
            ...
            // Perform actions based on the detected emotion
            switch (emotion_s) {
                case "Happy":
                    //showEmoji("\uD83D\uDE00");
                    // Vibrate for 100 milliseconds
                    if (vibrator != null) {
                        vibrator.vibrate(happyVibrationPattern, -1);
                    }
                    // Perform additional actions for Happy emotion
                ...
                case "Sad":
                    ...
                    if (vibrator != null) {
                        vibrator.vibrate(sadVibrationPattern,-1);
                    }
                    // Perform additional actions for Sad emotion
                    // Pause for 500 milliseconds
                ...
                case "Angry":
                    ...
                    if (vibrator != null) {
                        vibrator.vibrate(angryVibrationPattern,-1);
                    }
                    // Perform additional actions for Angry emotion
                    // Pause for 500 milliseconds
                ...
                case "Surprise":
                    ...
                    if (vibrator != null) {
                        vibrator.vibrate(surpriseVibrationPattern,-1);
                    }
                    // Perform additional actions for Surprise emotion
                    // Pause for 500 milliseconds
                ...
                case "Disgust":
                   // showEmoji("\uD83D\uDE12");
                    ...
                    if (vibrator != null) {
                        vibrator.vibrate(disgustVibrationPattern,-1);
                    }
                    // Perform additional actions for Disgust emotion
                    // Pause for 500 milliseconds
...
// Trigger vibrations when face is detected
